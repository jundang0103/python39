...
# 또한, 둘이상의 논리식이나 관계식으로 구성한 수식
# 논리식의 경우, 수식의 구성에 따라 단축식 평가가 가능
print(( 5 == 3) and (5 > 3))
print ((5 != 3) or (5 > 3 ))

# and 연산시 첫번째 수식이 F면 단축식평가 적용
# or 연산시 첫번째 수식의 결과가 T 면 단축식 평가 적용
avavg= 95.6
score = 85
print(2<3 and 3<5, "\t", 2<3 and 3>5)
print(2<3 or 3<5, "\t", 2>3 or 3<5, "\t", 2>3 or 3>5)
print(not(2<3 and 3<5), "\t", not(2>3 or 3<5))
print(not(56<=78), "\t", avavg>=80 and avavg<90)
